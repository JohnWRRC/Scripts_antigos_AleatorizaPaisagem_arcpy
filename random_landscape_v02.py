...
output_file=r'C:\Users\Marcos\Dropbox\ANALISE_R_MESTRADO_MARCOS_UFRPE\DADOS_PAISAGEM\marcos_ufrpe\shp\SAD69_test\trash02.gdb'

#________________________________________

#mapa original
frags_ori="frags_SJ_MN"
#copiando arquivo
...
env.workspace=r'C:\Users\Marcos\Dropbox\ANALISE_R_MESTRADO_MARCOS_UFRPE\DADOS_PAISAGEM\marcos_ufrpe\shp\SAD69_test\trash02.gdb\\'
out_path = r'C:\Users\Marcos\Dropbox\ANALISE_R_MESTRADO_MARCOS_UFRPE\DADOS_PAISAGEM\marcos_ufrpe\shp\SAD69_test\trash02.gdb\\'
...
def insert_to(interserct_explod,arc_acumula):
    ...
    for row in cur:
        ...
        for i in range(0,x): 
            ...
            feat.shape = shp
            cur.insertRow(feat)
    arcpy.AddGeometryAttributes_management(arc_acumula, 'CENTROID', '#', '#', '#')
...
for row in rows_frag:
    ...
    arcpy.Intersect_analysis('frags_copy #',
