...
output_file=r'E:\data_2015\___john\marcos_ufrpe\shp\SAD69_teste\trash09.gdb'
...
env.workspace=r'E:\data_2015\___john\marcos_ufrpe\shp\SAD69_teste\trash09.gdb\\'
out_path = r'E:\data_2015\___john\marcos_ufrpe\shp\SAD69_teste\trash09.gdb\\'
...
# mapa apoio para evitar intersectcao

out_path = r'E:\data_2015\___john\marcos_ufrpe\shp\SAD69_teste\trash09.gdb\\'
out_name = 'Mapa_frags_apoio'
geometry_type = "POLYGON"
template = frags_com_pacth
has_m = "DISABLED"
has_z = "DISABLED"
...
def random():
    ...
    for row in rows_frag:
        ...
        arcpy.Intersect_analysis(output_file+'/Mapa_frags_apoio',
        ...
        insert_to(frags_sem_pacth, output_file+'/Mapa_frags_apoio') 
        arcpy.SelectLayerByAttribute_management(frags_sem_pacth,"CLEAR_SELECTION")
        
        cont=cont+1
        cont_lixo=cont_lixo+1
    #arcpy.Dissolve_management(output_file+'/Mapa_frags_apoio',output_file+'/Mapa_frags_apoio_diss'+format, '#', '#', 'MULTI_PART', 'DISSOLVE_LINES')    
    #arcpy.CopyFeatures_management(output_file+'/frags_copy', output_file+'/frags_copy'=) 
    #cont_lines_result_merge=con_lines(intersect_01)

#cont_lines_result=con_lines(output_file+'/Acumula_frags_v01')
